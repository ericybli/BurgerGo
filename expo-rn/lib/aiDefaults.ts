/** AI-summary defaults, copied verbatim from the web `src/lib/openai/defaults.ts`. */
export const DEFAULT_AI_MODEL = 'gpt-5.4-mini';

export const AI_MODELS: readonly string[] = ['gpt-5.5-pro', 'gpt-5.5', 'gpt-5.4-mini', 'gpt-5.4-nano'];
