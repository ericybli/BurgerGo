...
const markers: PlaceMarker[] = [
  { id: 'a', name: 'A', position: { lat: 1, lng: 2 }, label: '1', color: '#ee5b3c', category: 'sightseeing', googlePlaceId: null, photoPath: null },
  { id: 'b', name: 'B', position: { lat: 3, lng: 4 }, label: '2', color: '#4f8a86', category: 'lodging', googlePlaceId: null, photoPath: null },
];
