...
export function ListPickerSheet({
  ...
  const itemClass =
    'w-full rounded-control border border-line bg-paper px-3 py-2.5 text-left text-body text-ink active:bg-line';
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-title font-bold text-ink">{t('moveToListTitle')}</h2>
